...
def xio_c():
    ...
    defence_c = 0.1
    xios[0] = xios[0] + 1
    easygui.msgbox('电脑:xio,计数器' + str(xios),image="source/b1.gif",ok_button='继续')


def dibo_c():
    global defence_c, xios
    defence_c = 1
    easygui.msgbox('电脑:地波,计数器'+str(xios),image="source/b2.gif",ok_button='继续')


def tianbo_c():
    global defence_c, xios
    defence_c = 1
    easygui.msgbox('电脑:天波,计数器'+str(xios),image="source/b3.gif",ok_button='继续')
...
def chaofang_c():
    ...
    defence_c = 9
    xios[0] = xios[0] - 1
    easygui.msgbox('电脑:超防,计数器'+str(xios),image="source/b4.gif",ok_button='继续')
...
def leiba_c():
    ...
    attack_c = 0.3
    xios[0] = xios[0] - 0.3
    easygui.msgbox('电脑:雷扒,计数器'+str(xios),image="source/b5.gif",ok_button='继续')
...
def momo_c():
    ...
    attack_c = 1
    xios[0] = xios[0] - 1
    easygui.msgbox('电脑:摸摸,计数器'+str(xios),image="source/b6.gif",ok_button='继续')
...
def sankan_c():
    ...
    attack_c = 3
    xios[0] = xios[0] - 3
    easygui.msgbox('电脑:三砍,计数器'+str(xios),image="source/b7.gif",ok_button='继续')
...
def wuhe_c():
    ...
    attack_c = 5
    xios[0] = xios[0] - 5
    easygui.msgbox('电脑:五合体,计数器'+str(xios),image="source/b8.gif",ok_button='继续')
...
def huhe_c():
    ...
    attack_c = 10
    xios[0] = xios[0] - 10
    easygui.msgbox('电脑:虎合体,计数器'+str(xios),image="source/b9.gif",ok_button='继续')
...
#游戏结束状态
def bao():
    easygui.msgbox('你爆死，游戏结束',image="source/b11.gif",ok_button='结束游戏')
    sys.exit()
	
def win():
    easygui.msgbox('你赢了，游戏结束',image="source/b10.gif",ok_button='结束游戏')
    sys.exit()


def lose():
    easygui.msgbox('你输了，游戏结束',image="source/b11.gif",ok_button='结束游戏')
    sys.exit()
...
def user():
	...
	#接受用户输入
	usr = easygui.enterbox("请出招式(输入'q'退出程序)")
	if usr == 'q':
		sys.exit()
	if usr == 'xio':
		xio_u()
